...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/get_profile","/profile/get_profile","/profile/**","/userdashboard","/tax-knowledge","/contact-us","/user_register","/user_login","/resources/**","/", "/login", "/signin","#userlogin","#useregister").permitAll()
